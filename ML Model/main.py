...
def main(args):
    ...
    if args.test_windows:
        ...
        window_optimization.performance_score_for_windows(args.test_windows[0], args.test_windows[1], args.test_windows[2],
                                                          verbose=False, write_to_file=True)
    ...
    if args.leave_one_out:
        ...
        leave_one_out_cv.clf_performance_with_user_left_out_vs_normal(X, y, True)  # Works
...
if __name__ == '__main__':
    ...
    parser.add_argument('-test_windows', type=int, nargs=3,
    ...
    parser.add_argument('--use_test_data', action='store_true', help='Plot performance when leaving out a logfile '
                                                                     'vs leaving out a whole user in crossvalidation')
